export default function Main() {
  return (
    <section className="body-font">
      <div className="max-w-7xl mx-auto flex px-5 py-64 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
          <h1 className="mb-5 sm:text-6xl text-5xl items-center Avenir xl:w-2/2 text-gray-900">
            Your Go-To Home Repair Solution
          </h1>
          <p className="mb-4 xl:w-3/4 text-lg text-gray-700">
          ...
          <div className="flex justify-center">
            <a
              className="inline-flex items-center px-5 py-3 mt-2 bgLaranja text-black font-bold  transition duration-500 ease-in-out transform bg-transparent border rounded-lg bg-gray-900"
              href="https://fixpal.co.uk"
            >
              <span className="justify-center">Fix my home</span>
              <svg
